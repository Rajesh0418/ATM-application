...
public class TransferAccountHandler {
    ...
    // this method is for to check whether the transferred account details are exsists or not in the db
    public  boolean findTransferUserDetails(String accountholdername,String accountnumber,String cardNumber,String ifsccode,String phoneNumber)
    {
        ...
        try
        {
            ...
            st.setString(1, accountholdername.toUpperCase());
    ...
    // this method is for to updating the amount of transferred person account
    public boolean updateTransferAccountDetails(double transferedAmount,String accountholdername, String accountnumber,String cardNumber,String ifsccode,String phoneNumber) {

    	if(findTransferUserDetails(accountholdername,accountnumber,cardNumber,ifsccode,phoneNumber))
    	{
	        ...
	        this.balance=this.balance+transferedAmount;
	        try
	        {
	            PreparedStatement st = (loginDao.getConnection()).prepareStatement(query);
